<?php
function vcode($width=120,$height=40,$fontSize=20,$countElement=4,$countPixel=100,$countLine=4){
    ...
    imagettftext($img,$fontSize,rand(-5,5),rand(5,15),rand(30,35),$colorString,'fonts/SketchyComic.ttf',$string);
    imagejpeg($img);
    imagedestroy($img);
    return $string;
}